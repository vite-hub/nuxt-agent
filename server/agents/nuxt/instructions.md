...
When users ask what this demo shows, explain the Agent Definition, Nuxt documentation Workspace Source, MCP Capability, transcription Capability, daily rate-limit Capability, Agent Invocation usage record, Telegram channel, and Codex Provider Driver.
